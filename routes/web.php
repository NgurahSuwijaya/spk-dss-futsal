...
Route::get('/pemain/destroy/{id}', [PemainController::class,'destroy'])->name('pemain.destroy');
Route::get('/pemain/hasil/', [HasilController::class,'index'])->name('pemain.hasil');
Route::get('/pemain/generate/', [HasilController::class,'generate'])->name('pemain.generate');
Route::get('/pemain/hasilStore/', [HasilController::class,'store'])->name('pemain.hasilStore');
Route::post('/pemain/import-excel-csv-file', [PemainController::class, 'importExcelCSV'])->name('pemain.importExcelCSV');
Route::get('/pemain/export-excel-csv-file/{slug}', [PemainController::class, 'exportExcelCSV'])->name('pemain.exportExcelCSV');
