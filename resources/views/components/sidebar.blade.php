<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('pemain') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('pemain') }}"><i class="fa fa-list"></i> <span>Daftar Pemain</span></a>
            </li>
            <li class="{{ Request::is('pemain/hasil') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('pemain/hasil') }}"><i class="fa fa-check"></i> <span>Hasil</span></a>
            </li>
